...
def test_class_schema_normalizes_mutable_names_to_a_tuple() -> None:
    names = ["Cr", "In", "Pa", "PS", "RS", "Sc"]
    schema = ClassSchema("schema-1", "steel-defects-v1", names)  # type: ignore[arg-type]
    names[3] = "other"
    assert schema.names == ("Cr", "In", "Pa", "PS", "RS", "Sc")
    assert schema.class_name(3) == "PS"
